...
import com.dmsskbm.agrigroww.admin.VideoPlayerActivity;
...
public class MessagesAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class){
            ...
            viewHolder.textView_senderMessage.setText(message.getMessage());
            ...
            try{
                if (message.getMessageType().equals("photo")) {
                    ...
                    Glide.with(context).load(message.getDataUrl()).addListener(new RequestListener<Drawable>() {
                            ...
                            .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).into(viewHolder.imageView_senderImage);
            ...
            try{ //setting receiver role and name
                String isUser = message.getIsUser();
                String isExpert = message.getIsExpert();

                if (isUser.equals("YES")) {
                    String receiverRoleAndName = "@User : " + message.getName();
