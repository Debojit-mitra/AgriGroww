...
import com.dmsskbm.agrigroww.admin.extras.SmsBroadcastReceiver;
                            ...
                            if (task.isSuccessful()) {
                                ...
                                referenceProfile.child(firebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        if (snapshot.exists()) {
                                            Toast.makeText(OtpActivity.this, "This App is not for users! Please log in using Agrigoww from playstore!", Toast.LENGTH_SHORT).show();
                                            try {
                                                authProfile.signOut();
                                                Intent intent = new Intent(OtpActivity.this, ErrorActivity.class);
                                                intent.putExtra("ExtraText", "This App is not for users! Please log in using Agrigoww from playstore!");
                                            ...
                                            referenceProfile.child(firebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    if (snapshot.exists()) {
                                                        Toast.makeText(OtpActivity.this, "This App is not for Experts! Please log in using Agrigroww Experts!", Toast.LENGTH_SHORT).show();
                                                        try {
                                                            authProfile.signOut();
                                                            Intent intent = new Intent(OtpActivity.this, ErrorActivity.class);
                                                            intent.putExtra("ExtraText", "This App is not for Experts! Please log in using Agrigroww Experts!");
                                                            startActivity(intent);
                                                            finish();
                                                        } catch (Exception e) {
                                                            e.printStackTrace();
